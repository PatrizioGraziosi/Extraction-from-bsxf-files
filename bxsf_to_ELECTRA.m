...
for id_band = 1:num_of_bands
    ...
    function [ Ek_i, kx_matrix_i, ky_matrix_i, kz_matrix_i ] = ...
        ...
        for i = 1:n_bands
            ...
            Ek_temp = Ek(:,:,:,i);
            Ek_m_temp = griddata(kx_matrix,ky_matrix,kz_matrix,Ek_temp,Kx_interp,Ky_interp,Kz_interp,'natural');
            ...
            for i_p = 1:size(kx_n,2)
                ...
                [indexes,dists] = findNearestNeighbors(ptCloud,[kx_n(i_p),ky_n(i_p),kz_n(i_p)],12) ;
